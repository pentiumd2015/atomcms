...
<div class="navbar navbar-inverse" role="navigation">
  ...
  <ul class="nav navbar-nav navbar-right collapse" id="navbar-icons">
    ...
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><i class="icon-paragraph-justify2"></i><span class="label label-default">6</span></a>
      <div class="popup dropdown-menu dropdown-menu-right">
        ...
        <?/*<ul class="popup-messages">
          <li class="unread"><a href="#"><img src="<?=$this->app("template")->templatePath;?>/images/demo/users/face1.png" alt="" class="user-face"><strong>Eugene Kopyov <i class="icon-attachment2"></i></strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?=$this->app("template")->templatePath;?>/images/demo/users/face2.png" alt="" class="user-face"><strong>Jason Goldsmith <i class="icon-attachment2"></i></strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?=$this->app("template")->templatePath;?>/images/demo/users/face3.png" alt="" class="user-face"><strong>Angel Novator</strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?=$this->app("template")->templatePath;?>/images/demo/users/face4.png" alt="" class="user-face"><strong>Monica Bloomberg</strong><span>Aliquam interdum convallis massa...</span></a></li>
          <li><a href="#"><img src="<?=$this->app("template")->templatePath;?>/images/demo/users/face5.png" alt="" class="user-face"><strong>Patrick Winsleur</strong><span>Aliquam interdum convallis massa...</span></a></li>
        </ul>*/?>
      </div>
    </li>
    ...
    <li class="user dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><?/*<img src="<?=$this->app("template")->templatePath;?>/images/demo/users/face1.png" alt="">*/?><span>Eugene Kopyov</span><i class="caret"></i></a>
