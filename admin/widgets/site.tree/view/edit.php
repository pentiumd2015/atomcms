<div class="page-header">
    <div class="page-title">
        <h3>Страница: <?=$arFormData["title"];?><small>Редактирование страницы</small></h3>
    </div>
</div>
<?
    if(count($arErrors)){
...
<div class="tabbable">
    ...
    <form class="form-horizontal route_form" method="POST" action="<?=$editURL;?>">
        <div class="tab-content with-padding">
            <div class="tab-pane fade in active" id="route">
                <?include(__DIR__ . "/include/route_edit.php");?>
            </div>
