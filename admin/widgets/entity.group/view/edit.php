...
<div class="page-header">
    <div class="page-title">
        <h3><?=$arFormData["title"];?><small>Редактирование группы</small></h3>
    </div>
</div>
<?
    if(count($arErrors)){
        ?>
            <div class="callout callout-danger fade in">
                ...
                <h5>Ошибка изменения группы</h5>
                <p>При изменении группы возникли ошибки.</p>
            </div>
        <?
    }
?>
<form class="form-horizontal entity_group_form" method="POST" action="<?=$editURL;?>">
