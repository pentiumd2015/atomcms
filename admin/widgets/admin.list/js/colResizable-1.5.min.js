...
(function($){ 	
	...
	h.append("<style type='text/css'> .JColResizer th{overflow:hidden;}  .JCLRgrips{ height:0px; position:relative;} .JCLRgrip{position:absolute; z-index:5; } .JCLRgrip .JColResizer{position:absolute;width:10px;height:100%;cursor: e-resize;top:0px;left:-5px;} .JCLRLastGrip{position:absolute; width:1px; } .JCLRgripDrag{ border-left:1px dotted black;	} .JCLRFlex{width:auto!important;}</style>");
    ...
    $.fn.extend({  
        colResizable: function(options) {           
            var defaults = {
				...
				minWidth: 50, 					//minimum width value in pixels allowed for a column 
