...
<div class="page-header">
    <div class="page-title">
        <h3><?=$arFormData["title"];?><small>Редактирование сайта</small></h3>
    </div>
</div>
<?
    if(count($arErrors)){
...
?>
<form class="form-horizontal site_form" method="POST" action="<?=$editUrl;?>">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="form-group<?=($arErrors["site_id"] ? " has-error" : "")?>">
                ...
                <div class="col-sm-2">
                    <div style="padding: 8px 0px;"><?=$arFormData["site_id"];?></div>
                </div>
            </div>
