...
<div class="page-header">
    <div class="page-title">
        ...
        <small><?=$obEntity->params["signatures"][Entity::SIGNATURE_ELEMENT]["title"];?></small></h3>
    </div>
</div>
<?
    if(count($arErrors)){
...
<div class="tabbable item_tabs_container">
    ...
    <form class="form-horizontal entity_item_form" method="POST" action="<?=str_replace("{ID}", $obEntityElement->entity_item_id, $editElementURL);?>">
