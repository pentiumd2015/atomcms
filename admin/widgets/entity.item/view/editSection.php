...
<div class="page-header">
    <div class="page-title">
        <h3>ID: <?=$arFormData["entity_item_id"];?> - <?=$arFormData["title"];?>
        <small><?=$obEntity->params["signatures"][Entity::SIGNATURE_SECTION]["title"];?></small></h3>
    </div>
</div>
<?
    if(count($arErrors)){
...
<div class="tabbable item_tabs_container">
    ...
    <form class="form-horizontal entity_item_form" method="POST" action="<?=str_replace("{ID}", $obEntitySection->entity_item_id, $editElementURL);?>">
                                                    ...
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div id="view_group_<?=($tabIndex + 1);?>_<?=($itemIndex + 1);?>" class="panel-collapse collapse in">
                                                            <div class="panel-body">
                                                                <?
                                                                    if($arTabItem["fields"]){
                                                                        foreach($arTabItem["fields"] AS $arTabField){ //fields
