<?
use \Entities\EntityFieldTypes\FieldTypeText;
use \Helpers\CHtml;
                        ...
                        if(is_array($arValues)){
                            ...
                            foreach($arValues AS $valueID => $value){
                                if($valueID == "n"){
                                    ...
                                    foreach($arValue AS $value){
                                        ?>
                                            <div class="row item_field_value<?=($arErrors ? " has-error" : "")?>">
                                                <div class="col-sm-9">
                                                    <?=CHtml::textarea("entity_item[" . $obField->entity_field_id . "][n][]", $value, array(
                                                        "class" => "form-control",
                                    ...
                                    $value = (is_array($value) ? $value[FieldTypeText::VALUE_NAME] : $value);                                    
                                    ?>
                                        <div class="row item_field_value<?=($arErrors ? " has-error" : "")?>">
                                            <div class="col-sm-9">
                                                <?=CHtml::textarea("entity_item[" . $obField->entity_field_id . "][" . $valueID . "]", $value, array(
                                                    "class" => "form-control",
                                                    "style" => "resize:vertical;"
                                                ));?>
                                            </div>
                            ...
                            ?>
                                <div class="row item_field_value<?=($arErrors ? " has-error" : "")?>">
                                    <div class="col-sm-9">
                                        <?=CHtml::textarea("entity_item[" . $obField->entity_field_id . "][n][]", "", array(
                                            "class" => "form-control",
                                            "style" => "resize:vertical;"
                                        ));?>
                                    </div>
