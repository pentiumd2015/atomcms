                                        ...
                                        if(is_array($value)){
                                            ...
                                            foreach($arValues AS $title){
                                                ?>
                                                    <div class="row">
                                                        <div class="col-sm-9">
                                                            <?=CHtml::password($arParams["requestArrayName"] . "[" . $fieldName . "][]", $title, array(
                                                                "class" => "form-control"
                                                            ));?>
                                                            <?
                                            ...
                                            ?>
                                                <div class="row">
                                                    <div class="col-sm-9">
                                                        <?=CHtml::password($arParams["requestArrayName"] . "[" . $fieldName . "][]", "", array(
                                                            "class" => "form-control",
                                                        ));?>
                                                        <?
                ...
                ?>
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 control-content">
                            <div class="row">
                                <div class="col-sm-9">
                                    <?=CHtml::password($arParams["requestArrayName"] . "[" . $fieldName . "]", $value, array(
                                        "class" => "form-control"
                                    ));?>
                                    <?
                                        if($arParams["description"]){
