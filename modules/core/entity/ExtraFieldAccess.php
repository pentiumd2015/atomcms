...
class ExtraFieldAccess extends Manager{
    static protected $_table    = "new_entity_extra_field_access";
    ...
    static protected $arEvents = array(
        "ADD"       => "ENTITY.EXTRA.FIELD.ACCESS.ADD",
        "UPDATE"    => "ENTITY.EXTRA.FIELD.ACCESS.UPDATE",
        "DELETE"    => "ENTITY.EXTRA.FIELD.ACCESS.DELETE",
    );
    ...
    static public function getFields(){
        return array(
            ...
            new Field\IntegerField("extra_field_id", array(
                "title"     => "Entity Extra Field ID",
                "required"  => true,
                "visible"   => true,
                "disabled"  => true
            )),
